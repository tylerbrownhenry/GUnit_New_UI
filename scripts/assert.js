...
(function(window) {
    ...
    function done() {
        ...
        banner = id("qunit-banner"),
            ...
            runtime, " milliseconds.<br/>", "<span class='passed'>",
            passed, "</span> assertions of <span class='total'>",
            config.stats.all, "</span> passed, <span class='failed'>",
